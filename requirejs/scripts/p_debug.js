...
(function () {
    ...
    // It is used as a subdomain for the pixel/config servers:
    // - srv-YYYY-MM-DD-HH.config.parsely.com
    // - srv-YYYY-MM-DD-HH.pixel.parsely.com
    var date = new Date(),
    ...
    var apikey = PARSELY.site || root.getAttribute('data-parsely-site'),
        ...
        // Re: the srv-{dateString}.(config|pixel).parsely.com, this is due to some DNS clients caching
    ...
    PARSELY.pInit = function(config) {
        ...
        console.log("Configuration loaded; loading Parse.ly plugin bundle");
        ...
        $LAB.script(bundle).wait(function() {
            ...
            if (typeof onload === "function") {
                try {
                    ...
                    console.dir({"info": "hook threw exception", "error": err});
                }
            }
